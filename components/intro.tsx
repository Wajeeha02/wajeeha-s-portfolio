...
import wajeeha from '@/public/wajee.jpg';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold text-[#d2ae3b]">Wajeeha Usman .</span> 
      </motion.h1>
      ...
      >
        ...
        <a
          className="group bg-white text-[#d2ae3b] px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10"
          href="/Wajeeha Usman Resume.pdf"
          download
        >
          Download CV{" "}
